...
richtet.
\input{grafiken/vorgehensmodell2d}
...
\input{tabellen/chancen_der_cloud}
\subsection{Risiken der Cloud}
\input{tabellen/risiken_der_cloud}
...
Methode der 
SWOT-Analyse 
\pcite{}{501}{marketingmanagement}, 
\pcite{}{6}{cloud-computing_the_business_perspective} - berücksichtigen. 
...
\input{grafiken/funktionsumfang_wasserfallmodell}
...
\input{grafiken/funktionsumfang_agil}
...
\pcite{}{}{changes_in_requirements_engineering,transitioning_to_saas} Unter 
...
aufgeführt.
\input{tabellen/unterschiede_im_re}

Um die Änderungen im Requirements Engineering zu reagieren, empfehlen 
\citeflow{changes_in_requirements_engineering} die folgenden Schritte:
\begin{enumerate}
