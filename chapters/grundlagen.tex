...
\input{grafiken/XaaS_im_Vergleich}
\begin{comment}
\begin{figure}%[h]
\begin{center}
...
\begin{center}
\newcommand{\tw}{0.138}
\begin{tabular}{|p{\tw\textwidth}|p{\tw\textwidth}|p{\tw\textwidth}|p{\tw\textwidth}|p{\tw\textwidth}|p{\tw\textwidth}|}
\hline
\textbf{Verkaufs-\newline preis} & \textbf{Akquisitions\-kosten} & \textbf{Vertriebs\-personal} & \textbf{Kunden\-beziehung} & \textbf{Akzeptabler Schulungsaufwand} & \textbf{Beispiel\-hafter Kunde} \\
\hline
€€€ & Hoch & Extern & Persönlich & Erheblich & Unternehmen \\
\hline
€€ & Moderat & Intern & Telefonisch & Moderat & Abteilung, KMU \\
\hline
€ & Niedrig & Nicht\newline vorhanden & Internet & Minimal & KMU,\newline Individuen \\
\hline
\end{tabular}
\caption{Der Einfluss des Preises auf das Geschäft. Aus
\protect\citeflow{how_saas_changes_an_isvs_business} }
\label{tab:einfluss_des_preises_auf_business}
\end{center}
\end{figure}
...
dargestellt sind. 
\input{grafiken/5phasenwasserfallmodell}
\begin{comment}
\begin{figure}[!h]
\begin{center}
